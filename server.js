...
//      console.log(updateDoc.body);

      var docb = '' + updateDoc.body;

      var arr = [];
      var temp = '';
      var num = 0;
  
      for(var i = 0; i < docb.length; i++)
      {
          if(docb[i] != ' ')
          {
              temp += docb[i];
      ...
      py.stdout.on('data', function(arr){
        dataToProcess += arr.toString();
      });

      py.stdout.on('end', function(){
          updateDoc.body = '' + dataToProcess.toString();
